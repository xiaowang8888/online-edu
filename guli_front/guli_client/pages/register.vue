<template>
  <div class="main">
    <div class="title">
      <a style="text-decoration: none" href="/login">登录</a>
      <span>·</span>
      <a style="text-decoration: none" class="active" href="/register">注册</a>
    </div>
    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="params">
        ...
        <el-form-item class="input-prepend restyle no-radius" prop="code" :rules="[{ required: true, message: '请输入验证码', trigger: 'blur' }]">
          ...
          <div class="btn" style="position:absolute;right: 0;top: 6px;width: 40%;">
            <a href="javascript:" type="button" @click="getCodeFun()" :value="codeTest" style="border: none;text-decoration:none">{{codeTest}}</a>
          </div>
        </el-form-item>
      ...
      <div class="more-sign">
        <h6>社交帐号直接注册</h6>
        <ul>
          <li><a style="text-decoration: none" id="weixin" class="weixin" target="_blank" href="http://huaan.free.idcfengye.com/api/ucenter/wx/login"><i
            class="iconfont icon-weixin"/></a></li>
          <li><a style="text-decoration: none" id="qq" class="qq" target="_blank" href="#"><i class="iconfont icon-qq"/></a></li>
        </ul>
      </div>
    </div>
  </div>
